...
import com.app.hinh.smart3g.util.Logger;
import com.app.hinh.smart3g.util.TopActivityUtils;
import com.app.hinh.smart3g.util.WarringActivity;
...
public class CoreSevice extends Service {
    ...
    private Runnable mRunnable = new Runnable() {
        @Override
        public void run() {
            com.app.hinh.smart3g.util.Logger.getLogger().d("block service is running...");
